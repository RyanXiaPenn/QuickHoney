...
{	
	...
	enum class ViscosityMethods { None = 0, Standard, XSPH, Bender2017, Peer2015, Peer2016, Takahashi2015, Weiler2018, NumViscosityMethods, QuickHoney};
	...
	*/
	class FluidModel : public GenParam::ParameterObject
	{
		public:
			...
			static int ENUM_VISCOSITY_QUICKHONEY;
