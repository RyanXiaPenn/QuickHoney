...
#include "Viscosity/Viscosity_QuickHoney.h"
...
int FluidModel::ENUM_VISCOSITY_QUICKHONEY = -1;
...
void FluidModel::initParameters()
{
	...
	enumParam->addEnumValue("QuickHoney", ENUM_VISCOSITY_QUICKHONEY);
...
void FluidModel::setViscosityMethod(const int val)
{
	...
	else if (m_viscosityMethod == ViscosityMethods::QuickHoney)
		m_viscosity = new Viscosity_QuickHoney(this);
