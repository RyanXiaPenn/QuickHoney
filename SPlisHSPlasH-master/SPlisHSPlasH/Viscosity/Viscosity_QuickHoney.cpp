#include "Viscosity_QuickHoney.h"
...
int Viscosity_QuickHoney::ITERATIONS = -1;
int Viscosity_QuickHoney::MAX_ITERATIONS = -1;
int Viscosity_QuickHoney::MAX_ERROR = -1;


Viscosity_QuickHoney::Viscosity_QuickHoney(FluidModel *model) :
	ViscosityBase(model)
{
...
Viscosity_QuickHoney::~Viscosity_QuickHoney(void)
{
...
void Viscosity_QuickHoney::initParameters()
{
...
void Viscosity_QuickHoney::computeDensities()
{
...
void Viscosity_QuickHoney::matrixVecProd(const Real* vec, Real *result, void *userData)
{
	Simulation *sim = Simulation::getCurrent();
	Viscosity_QuickHoney* visco = (Viscosity_QuickHoney*)userData;
...
void Viscosity_QuickHoney::diagonalMatrixElement(const unsigned int row, Real &result, void *userData)
{
	// Diagonal element
	Viscosity_QuickHoney* visco = (Viscosity_QuickHoney*)userData;
	FluidModel* model = visco->getModel();
...
void Viscosity_QuickHoney::step()
{
	Simulation *sim = Simulation::getCurrent();
...
void Viscosity_QuickHoney::reset()
{
}

void Viscosity_QuickHoney::performNeighborhoodSearchSort()
{
}
